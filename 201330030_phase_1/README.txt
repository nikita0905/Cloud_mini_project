...
first pm that satisfies the requirements

Location and names of my files
pm_file ---> /src/pm_file
image_file ----> /src/image_file
flavor_file ----> /src/types
...
IMPORTANT NOTE:pmid used is 0th index based as the first entry in my pm_list is my own laptop so it is assigned pmid=0 so for running any API calls like pm/query enter pmid=0 for the first physical machine (in my case my physical machine)
